          ...
          {!isSuccess ? (
            <>
              ...
              <div className="mt-6 text-center">
                <Link 
                  href="/login"
                  className="text-sm text-[#00A298] hover:text-[#1D3C44] transition-all duration-200 font-medium hover:underline hover:scale-102 cursor-pointer flex items-center justify-center space-x-2"
                >
