  ...
  return (
    <div className="min-h-screen flex items-center justify-center relative overflow-hidden">
        ...
        <div className="bg-white rounded-2xl shadow-2xl p-8 border border-gray-100">
              ...
              <div>
               ...
               <div className="text-center">
                 <Link 
                   ...
                   className="text-sm text-[#00A298] hover:text-[#1D3C44] transition-all duration-200 hover:underline hover:scale-102 cursor-pointer inline-block"
                 >
                   Esqueci minha Senha
                 </Link>
               </div>
          ...
          <div className="mt-3 text-center">
            <button
              ...
              className="text-sm text-[#00A298] hover:text-[#1D3C44] transition-all duration-200 font-medium hover:underline hover:scale-102 cursor-pointer"
            >
              {showCreateAccount 
      ...
      <div className="fixed bottom-6 right-6 z-30">
        <button className="bg-[#00A298] hover:bg-[#1D3C44] text-white px-4 py-2 rounded-full shadow-lg transition-all duration-200 transform hover:scale-102 hover:shadow-xl cursor-pointer flex items-center space-x-2">
