    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-50 via-gray-100 to-[#00A298]/15 pt-16">
      <main className="flex-1 p-6">
        <div className="max-w-7xl mx-auto">
          <div className="mb-6">
            <h1 className="text-3xl font-bold text-[#1D3C44] mb-2">Assinatura Digital</h1>
            <p className="text-gray-600">Assinatura digital de documentos das empresas</p>
          </div>
          ...
          <div className="bg-white rounded-xl shadow-lg p-6">
            <div className="text-center py-12">
              ...
              <h2 className="text-2xl font-bold text-[#1D3C44] mb-4">Assinatura Digital</h2>
              <p className="text-gray-600 mb-8">
                Esta seção está em desenvolvimento.<br />
                Em breve você poderá realizar assinaturas digitais de documentos das empresas.
              </p>
