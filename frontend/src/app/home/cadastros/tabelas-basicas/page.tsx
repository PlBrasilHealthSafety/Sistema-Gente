...
export default function TabelasBasicasPage() {
      ...
      <div className="pt-16">
        ...
        <div className="bg-white border-b border-gray-200 px-6 py-3">
          <nav className="flex items-center space-x-1 text-sm text-gray-500">
            ...
            <span>›</span>
            <span className="text-[#00A298] font-medium">Tabelas Básicas</span>
          </nav>
        </div>
          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="mb-6">
              ...
              <p className="text-gray-600">
                Cadastros fundamentais do sistema
              </p>
            </div>
              ...
              {tabelasBasicasItems.map((item) => (
                <div key={item.id} className="bg-white rounded-2xl shadow-xl p-6 hover:shadow-2xl transition-shadow duration-300">
                  ...
                  <div className="space-y-3">
                    ...
                    <button 
                      onClick={() => router.push(`/home/cadastros/tabelas-basicas/${item.id}`)}
