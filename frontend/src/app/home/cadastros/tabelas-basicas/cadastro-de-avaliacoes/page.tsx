...
export default function CadastroAvaliacoes() {
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-gray-600">
                Gerencie os tipos de avaliações e protocolos de análise
              </p>
            </div>
            <button
          ...
          <div className="text-center py-12">
            ...
            <div className="bg-[#00A298]/10 border border-[#00A298]/20 rounded-lg p-4 max-w-md mx-auto">
              <p className="text-[#1D3C44] text-sm">
                Em breve você poderá gerenciar diferentes tipos de avaliações médicas, ocupacionais e protocolos de análise.
              </p>
            </div>
          </div>
        </div>
