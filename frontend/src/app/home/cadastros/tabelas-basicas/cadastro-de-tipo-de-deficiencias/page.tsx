...
export default function CadastroTipoDeficiencias() {
          ...
          <div className="flex items-center justify-between">
            <div>
              <h1 className="text-2xl font-bold text-[#1D3C44] mb-2">
                Cadastro de Tipo de Deficiências
              </h1>
              <p className="text-gray-600">
                Gerencie os tipos de deficiências e necessidades especiais
              </p>
            </div>
            <button
          ...
          <div className="text-center py-12">
            ...
            <div className="bg-[#00A298]/10 border border-[#00A298]/20 rounded-lg p-4 max-w-md mx-auto">
              <p className="text-[#1D3C44] text-sm">
                Em breve você poderá gerenciar diferentes tipos de deficiências físicas, intelectuais, sensoriais e múltiplas.
              </p>
            </div>
          </div>
        </div>
