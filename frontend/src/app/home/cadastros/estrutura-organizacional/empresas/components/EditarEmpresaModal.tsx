...
export const EditarEmpresaModal: React.FC<EditarEmpresaModalProps> = ({
  isOpen,
  onClose,
  empresa,
  regioesAtivas,
  ...
  }, [isOpen, empresa, regioesAtivas, gruposAtivos, carregarEmpresa]);
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      await empresasService.atualizarEmpresa(empresa.id, formData);
      ...
      setNotification({
        type: 'error',
        message: 'Ocorreu um erro ao atualizar a empresa. Tente novamente.'
      });
    }
  };
    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
      <div className="bg-white rounded-lg max-w-4xl w-full max-h-[90vh] overflow-hidden">
        ...
        <form onSubmit={handleSubmit} className="flex flex-col h-full">
          ...
          {/* Conteúdo das abas - mesmo conteúdo do NovaEmpresaModal */}
